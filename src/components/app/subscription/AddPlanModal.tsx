...
import { X, Zap, Star, Crown, Rocket, Gem, Trophy, Sun, Flame, Plus, Trash2 } from 'lucide-react'
...
interface AddPlanModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (data: Omit<SubscriptionPlan, 'id'>) => void;
  nextDisplayOrder: number;
}

const AddPlanModal = ({ isOpen, onClose, onAdd, nextDisplayOrder }: AddPlanModalProps) => {
  const iconList = [
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50 shrink-0">
          <div>
            <h2 className="text-sm font-bold text-gray-900 leading-tight">Add New Plan</h2>
            <p className="text-[10px] text-gray-400 mt-0.5 leading-none">Create a new subscription plan</p>
          </div>
          <button
            onClick={onClose}
